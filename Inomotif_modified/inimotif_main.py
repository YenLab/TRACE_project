...
class FileProcessor:
    def __init__(self, file_name=None, file_type="fasta", out_dir=".",
              ...
              consensus_seq=None, n_max_mutation=2, kmer_dict=None, motif_pwm=None): #add motif_pwm
        ...
        #pwm_matrix to be save
        self.motif_forward_file = 'motif_forward.txt'
        self.motif_revcom_file = 'motif_revcom.txt'

        # file names to be saved
        self.preproc_res_file = 'preproc.pickle'
        self.logo_forward_file = 'logo.forward.svg'
        self.logo_revcom_file = 'logo.revcom.svg'
        self.motif_posdis_file = 'posdis.png'
        self.kmer_hamdis_file = 'hamdis.pdf'
    ...
    def mk_txt(self):
        kc = self.kmer_counter
        mm = self.motif_manager
        mm.mk_matrix(mm.forward_motif_mat, outfile=self.gen_absolute_path(self.motif_forward_file))
        mm.mk_matrix(mm.revcom_motif_mat, outfile=self.gen_absolute_path(self.motif_revcom_file))
...
class SelexSeqProcessor:
    ...
    def run(self):
        ...
        for kmer_len in range(self.min_kmer_len, self.max_kmer_len+1):
            ...
            trend_fig_file = self.out_dir + os.sep + self.trend_figure_dir + os.sep + f'k{kmer_len}.svg'
    ...
    def mk_kmer_trend_fig(self, selex_round_res_list, outfile="selex_trend.svg"):
...
#     #in_file = "/share/home/sango/software/IniMotif-master/test1/r1k20/preproc.pickle"
...
#     # ssp.run()
    ...
    in_dir = "/share/home/sango/data/selex_seq/2017_science/2_fa_file/"
    file_list = ['RUNX2_eDBD_Bis_3_bHT40N.fa', 'RUNX2_eDBD_Bis_4_bHT40N.fa']
    file_name_arr = [in_dir + f for f in file_list]
    out_dir = '/share/home/sango/data/selex_seq/2017_science/4_inmotif_kmer/RUNX2_eDBD_Bis_12_30'

    ssp = SelexSeqProcessor(file_name_arr=file_name_arr, identifier='RUNX2_eDBD', min_kmer_len=12, max_kmer_len=30,
                            min_selex_round=3, max_selex_round=4, unique_kmer_in_seq_mode=True, revcom_flag=True,
                            consensus_seq=None, out_dir=out_dir)
    ssp.run()

    in_dir = "/share/home/sango/data/selex_seq/2017_science/2_fa_file/"
    file_list = ['RUNX2_eDBD_Nor_3_bHT40N.fa', 'RUNX2_eDBD_Nor_4_bHT40N.fa']
    file_name_arr = [in_dir + f for f in file_list]
    out_dir = '/share/home/sango/data/selex_seq/2017_science/4_inmotif_kmer/RUNX2_eDBD_Nor_12_30'
    ...
    in_dir = "/share/home/sango/data/selex_seq/2017_science/2_fa_file/"
    file_list = ['RUNX3_eDBD_Bis_3_bHT40N.fa', 'RUNX3_eDBD_Bis_4_bHT40N.fa']
    file_name_arr = [in_dir + f for f in file_list]
    out_dir = '/share/home/sango/data/selex_seq/2017_science/4_inmotif_kmer/RUNX3_eDBD_Bis_12_30'

    ssp = SelexSeqProcessor(file_name_arr=file_name_arr, identifier='RUNX3_eDBD', min_kmer_len=12, max_kmer_len=30,
                            min_selex_round=3, max_selex_round=4, unique_kmer_in_seq_mode=True, revcom_flag=True,
                            consensus_seq=None, out_dir=out_dir)
    ssp.run()

    in_dir = "/share/home/sango/data/selex_seq/2017_science/2_fa_file/"
    file_list = ['RUNX3_eDBD_Nor_3_bHT40N.fa', 'RUNX3_eDBD_Nor_4_bHT40N.fa']
    file_name_arr = [in_dir + f for f in file_list]
    out_dir = '/share/home/sango/data/selex_seq/2017_science/4_inmotif_kmer/RUNX3_eDBD_Nor_12_30'
