...
# LS change 746-750
    def mk_matrix(self, motif_mat, outfile="motif.txt"):
        with open(outfile, 'w') as f:
            for row in motif_mat:
...
#     fh.close()
#     foh.close()
from inimotif_main import FileProcessor
import matplotlib
...
if __name__=="__main__":
    ...
    # in_file = sys.argv[1]
    in_file = "/share/home/sango/software/IniMotif-master/exampledata/NF1-1.fa"
...
#     fp = FileProcessor(in_file, out_dir="./exampledata", kmer_len=12)
#
